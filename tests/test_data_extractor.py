...
class TestDataExtractor(unittest.TestCase):
    ...
    def test_extract_data(self):
        ...
        data = extractor.extract_data("/home/shtlp_0070/Documents/python_assignment_v2/files/sample.pdf")
    ...
    def test_extract_data_empty_file(self):
        ...
        loader = PDFLoader()
        extractor = PDFExtractor(loader)
        data = extractor.extract_data("/home/shtlp_0070/Documents/python_assignment_v2/files/empty.pdf")
    ...
    def test_extract_data_invalid_file(self):
        ...
        with self.assertRaises(FileNotFoundError):
            extractor.extract_data("/home/shtlp_0070/Documents/python_assignment_v2/files/non_existent_file.pdf")
