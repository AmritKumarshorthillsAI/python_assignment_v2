...
class TestFileLoaders(unittest.TestCase):
    ...
    def test_pdf_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/sample.pdf"
    ...
    def test_docx_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/sample.docx"
    ...
    def test_ppt_loader(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/sample.pptx"
    ...
    def test_pdf_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/non_existent_file.pdf"
        loader = PDFLoader(self.file_path)
    ...
    def test_docx_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/non_existent_file.docx"
        loader = DOCXLoader(self.file_path)
        self.assertFalse(loader.validate_file())
    ...
    def test_ppt_loader_invalid_file(self):
        ...
        """
        self.file_path = "/home/shtlp_0070/Documents/python_assignment_v2/files/non_existent_file.pptx"
        loader = PPTLoader(self.file_path)
        self.assertFalse(loader.validate_file())
